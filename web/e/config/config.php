...
$ecms_config['db']['dbusername']='xingwei-tech_com';	//数据库用户名
$ecms_config['db']['dbpassword']='xingwei-tech_com';	//数据库密码
$ecms_config['db']['dbname']='xingwei-tech_com';	//数据库名
...
$ecms_config['esafe']['ecookiernd']='svnfUwOwdBlFCoHeMA2pJRSxH32CoB9naNhl';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='rkhty';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='vikpq';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='SNYNqtZGpgqxRQrjV7lLGdod96V2bdBnNQf';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='u6GxhrESM79fSoi70mgj47lqnA4zHdhdI2';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndthree']='i3Wl8lmJixQCm2gEWRPbZiiIiRhziOtK5';	//COOKIE验证随机码3(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfour']='ik3UyTbknY5INwDkCJLGce3sjKmNL8Wk';	//COOKIE验证随机码4(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfive']='ZwzVIxlbditTFjF39WDfsvxGmdF7N4U';	//COOKIE验证随机码5(填写10~50个任意字符，最好多种字符组合)
...
'keytog'=>2,
'keytime'=>900,
'keyrnd'=>'iYrGIp1H17pnzbWj0m68e07ZdaRm1QKt',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/e/action/ListInfo/?classid=1\">product</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'ipaddinfonum'=>0,
'ipaddinfotime'=>0,
'rewriteinfo'=>'showinfo-[!--classid--]-[!--id--]-[!--page--].html',
'rewriteclass'=>'listinfo-[!--classid--]-[!--page--].html',
'rewriteinfotype'=>'infotype-[!--ttid--]-[!--page--].html',
'rewritetags'=>'tags-[!--tagname--]-[!--page--].html',
'rewritepl'=>'comment-[!--doaction--]-[!--classid--]-[!--id--]-[!--page--]-[!--myorder--]-[!--tempid--].html',
'memberconnectnum'=>0,
'closehmenu'=>'',
'indexaddpage'=>0,
'modmemberedittran'=>0,
...
'bakescapetype'=>1,
'hkeytime'=>30,
'hkeyrnd'=>'JLuZ2z0WnLzLmtT12rYOxCDHl6CLTO3MIJgV',
'mhavedatedo'=>0,
'reportkey'=>0,
'ctimeopen'=>0,
'ctimelast'=>0,
...
'ctimegids'=>'',
'ctimecids'=>'',
'ctimernd'=>'fWfybxwgFuWsksqVpL5oqnntjuq3AMGl4RLZKci5Oq',
'qmadminuids'=>'',
'qmforumuids'=>'',
'qmotheruids'=>'',
'ckhavemoreport'=>0,
